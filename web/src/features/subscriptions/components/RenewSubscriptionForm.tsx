  ...
  return (
    <div className="space-y-3 rounded-md border p-3">
      ...
      <p className="text-sm text-muted-foreground">
        همان پلن «{planName}» با قیمت و شرایط فعلی آن تمدید می‌شود. تاریخ شروع اشتراک تازه خودکار
        محاسبه می‌شود — اگر اشتراک فعلی این عضو هنوز جا دارد، پشت سر آن قرار می‌گیرد؛ وگرنه از همین
        امروز شروع می‌شود. بعد از تأیید، تاریخ دقیق همین‌جا نشان داده می‌شود.
      </p>
