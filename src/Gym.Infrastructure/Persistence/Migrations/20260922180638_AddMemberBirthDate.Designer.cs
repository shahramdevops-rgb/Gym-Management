...
namespace Gym.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922180638_AddMemberBirthDate")]
    partial class AddMemberBirthDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Domain.Attendances.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("AutoClosedAt")
                    ...
                    b.HasIndex("LockerId")
                        .IsUnique()
                        .HasDatabaseName("ix_attendances_one_open_per_locker")
                    ...
                    b.ToTable("attendances", null, t =>
                        {
                            t.HasCheckConstraint("ck_attendances_auto_close", "auto_closed_at IS NULL OR checked_out_at = auto_closed_at");
            ...
            modelBuilder.Entity("Gym.Domain.Members.Member", b =>
                {
                    ...
                    b.ToTable("members", null, t =>
                        {
                            t.HasCheckConstraint("ck_members_birth_date_range", "birth_date IS NULL OR birth_date >= DATE '1900-01-01'");
            ...
            modelBuilder.Entity("Gym.Domain.Attendances.Attendance", b =>
                {
                    b.HasOne("Gym.Domain.Lockers.Locker", null)
                        .WithMany()
                        .HasForeignKey("LockerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_attendances_lockers_locker_id");
