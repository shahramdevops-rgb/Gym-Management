        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cafe_order_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_payments_one_target", "num_nonnulls(subscription_id, cafe_order_id) = 1");
                    table.CheckConstraint("ck_payments_refund_reason", "kind = 'Payment' OR reason IS NOT NULL");
                    table.ForeignKey(
                        name: "fk_payments_asp_net_users_received_by_user_id",
